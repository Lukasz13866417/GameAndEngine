...
(() => {
  ...
  const neutral = [
    ...
    component("vng_shader", "Shader DSL & typed IR", "Execute shader-building C++ once, record operations and link stage contracts.",
      ...
      ["include/vng/dsl/expr.hpp", "include/vng/shader/stage.hpp", "include/vng/shader/ir.hpp", "include/vng/shader/arguments.hpp", "src/shader", "tests/shader"], ["vng_gfx"],
      { extra: { related: ["shader-dsl", "shader-arguments"] } }),
    component("vng_providers", "Reusable creation recipes", "Adapters for mesh, program, image, font, target and skin resource sources.",
    ...
    component("vng_text", "Font shaping & glyph data", "Fonts, shaped text and glyph bitmaps, without issuing OpenGL draws.",
      ...
      ["include/vng/text/font.hpp", "src/text", "tests/text"], ["vng_core"], { external: external("Freetype::Freetype", "vng_harfbuzz_dependency") }),
  ...
  const backends = [
    ...
    component("vng_glfw_opengl", "GLFW ↔ OpenGL bridge", "The explicit integration point between native windows and GL context creation/presentation.",
      ...
      ["include/vng/window/glfw_opengl.hpp", "src/integration/glfw_opengl.cpp", "examples/support/glfw_opengl_session.hpp"],
    ...
    component("vng_render_opengl", "Program runtime & analysis integration", "Realize normal and diagnostic shader paths and collect render evidence.",
      ...
      ["include/vng/render/opengl_program_runtime.hpp", "src/render/opengl_program_runtime.cpp", "tests/render/opengl_program_runtime_tests.cpp"],
    ...
    component("vng_resources_opengl", "Resource-backed mesh renderer", "Build and reload the resources needed by the reusable ticket-driven MeshRenderer.",
      ...
      ["include/vng/opengl/mesh_renderer.hpp", "include/vng/opengl/resources.hpp", "src/resources_opengl/mesh_renderer.cpp", "tests/opengl/resource_owner_tests.cpp"],
    ...
    component("vng_bloom_opengl", "Bloom renderer", "Extract and blur bright light, then composite it into a displayable image.",
      ...
      ["include/vng/render/bloom.hpp", "include/vng/opengl/bloom.hpp", "src/bloom_opengl/bloom.cpp", "tests/opengl/bloom_tests.cpp"],
    ...
    component("vng_rig_opengl", "Skinned-mesh renderer", "Use CPU skin bindings and changing bone palettes to deform mesh vertices on the GPU.",
      ...
      ["include/vng/opengl/skinned_mesh_renderer.hpp", "src/rig_opengl/skinned_mesh_renderer.cpp", "tests/opengl/skinned_renderer_tests.cpp"],
    ...
    component("vng_text_opengl", "Text renderer", "Turn text tickets into GPU glyph batches and maintain atlas resources.",
      ...
      ["include/vng/render/text_renderer.hpp", "include/vng/opengl/text_renderer.hpp", "src/text_opengl/text_renderer.cpp", "tests/opengl/text_renderer_tests.cpp"],
    ...
    component("vng_ui_opengl", "UI renderer", "Draw UI shapes and text from a Screen's drawing data.",
      ...
      ["include/vng/render/ui_renderer.hpp", "include/vng/opengl/ui_renderer.hpp", "src/ui_opengl/ui_renderer.cpp", "tests/opengl/ui_renderer_tests.cpp"],
  ...
  const applications = [
    ...
    component("vng_editor_app", "Editor UI application", "Assemble the session, retained controls, tools, worker communication and displayed preview.",
      ...
      ["vng_editor_project", "vng_editor_preview", "vng_ui_opengl", "vng_example_support", "vng_example_presentation"],
